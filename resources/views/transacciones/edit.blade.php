    ...
    <div class="row"  id="">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <ol class="breadcrumb">
                        <a href="{{route('transaccion.index')}}">Todas las transacciones / </a>
                        <li> Editar Transaccion</li>
                    </ol>
                    <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-1">
                            <button class="btn btn-primary btn-sm btn-block mes31" id="febrero">FEBRERO</button>
                        </div>
                        <div class="col-sm-4 col-md-1">
                    ...
                    <form class="user"  action="{{route('transaccion.update',$trasacciones->id)}}" method="post" id="puc"  name="puc">
                        {{csrf_field()}}
                        {{ method_field('put') }}
                        <div class="card-body">
                            <br>
                            ...
                            <div class="row"  id="numeroDocumentos" readonly="readonly" >
                                <div class="col-md-12" style="overflow:scroll;
                                    ...
                                    <table id="TablaPro" class="table">
                                        ...
                                        <td><input readonly="readonly" type="text" style="width:150px;" class="form-control form-control-user" name="totalDebito" id="totalDebito" data-id="{{$trasacciones->totalDebito}}" value="{{$trasacciones->totalDebito}}"></td>
                                        <td><input readonly="readonly" type="text" style="width:150px;" class="form-control form-control-user" name="totalCredito" id="totalCredito" data-id="{{$trasacciones->totalCredito}}" value="{{$trasacciones->totalCredito}}"></td>
